...
<div class="card p-4 p-md-5" style="border-radius:24px;box-shadow:0 20px 60px rgba(1,154,222,.12);">
  <div class="text-center mb-4">
    <div style="width:64px;height:64px;border-radius:50%;background:linear-gradient(135deg,#00d4aa,#019ADE);display:flex;align-items:center;justify-content:center;margin:0 auto 12px;font-size:1.6rem;color:#fff;"><i class="fa-solid fa-key"></i></div>
  ...
  <form action="../DoctorChangePassword" method="post">
    ...
    <div class="mb-4"><label class="form-label fw-600 small">Confirm Password</label><input type="password" id="conf" class="form-control" required></div>
